...
//            System.out.println(ClassLayout.parseInstance(clazz1).toPrintable());
            ...
            System.out.println(clazz1);
            Class<?> clazz2 = Class.forName("cn.violin.home.school.school.jvm.TestClassLoaderClass");
            System.out.println(clazz2);
            Class<?> clazz3 = ClassLoader.getSystemClassLoader().loadClass("cn.violin.home.school.school.jvm.TestClassLoaderClass");
